  ...
  <div className={styles.inputGroup}>
    <div className={styles.inputWrapper}>
      ...
      <div className={styles.chevron}>
        <svg className={styles.chevronIcon} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <form onSubmit={handleSubmit}>
        <div className={styles.grid}>
          ...
          <Input 
            ...
            type="text"
            placeholder="Date" 
            onFocus={(e: React.FocusEvent<HTMLInputElement>) => (e.currentTarget.type = 'date')}
            onBlur={(e: React.FocusEvent<HTMLInputElement>) => { if (!e.currentTarget.value) e.currentTarget.type = 'text'; }}
          ...
          <Input 
            ...
            type="text"
            placeholder="Time" 
            onFocus={(e: React.FocusEvent<HTMLInputElement>) => (e.currentTarget.type = 'time')}
            onBlur={(e: React.FocusEvent<HTMLInputElement>) => { if (!e.currentTarget.value) e.currentTarget.type = 'text'; }}
